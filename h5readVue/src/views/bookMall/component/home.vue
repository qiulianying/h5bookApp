<template>
    <!--首页模块-->
    <div>
        <div class="mall_home" v-if="!!indexData">
            <!--轮播-->
            ...
            <p class="mall_game_shrink" :class="{'game_shrink': gameOn,'game_shrink_on': !gameOn}" @click="gameShow()">&nbsp;</p>
            <!--//精选游戏-->
            ...
            <!--版权信息-->
            <div class="com_bg text_c mall_copyright">
                <p>
                    闽ICP备13007466号-3
                    <br/>福州佳软软件技术有限公司版权所有
                    <br/>微信搜索：“<span class="mall_blue">畅读书城</span>”关注官方公众号
                    <br/>书友交流或问题反馈请加入官方QQ群：“<span class="mall_blue">300181652</span>”
                </p>

                <div class="flex_sp mall_down">
                    <img class="mall_down_logo" src="../../../assets/images/logo_down.png"/>

                    <div class="mall_down_word text_l">
                        <h3 class="mall_down_tit">畅读书城</h3>

                        <p class="mall_down_con">小说全，更新快，天天发福利</p>
                    </div>
                    <router-link class="mall_down_btn" to="javascript:;">下载</router-link>
                </div>
            </div>
            <!--//版权信息-->
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            //热销排行榜切换
            changeHot(){
                this.hotRankMen = !this.hotRankMen;
                this.hotRank = this.indexData.module[this.hotRankMen ? '9' : '10'];
            },
            //热销排行榜切换
            changePeople(){
                this.peopleRankMen = !this.peopleRankMen;
                this.peopleRank = this.indexData.module[this.peopleRankMen ? '11' : '12'];
            },
            //点击游戏展开收起
            gameShow: function(){
                this.gameOn = !this.gameOn;
                if(this.itemListNumber === 4){
                    this.itemListNumber = this.indexData.module[8].itemList.length;
                }else {
                    this.itemListNumber = 4
                }
            }
        }, mounted: function () {
            this.initRequest();
